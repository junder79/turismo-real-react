...
function InicioWebsite() {
    ...
    return (
        ...
        <>
            ...
            {/* <div className="row mt-2 ml-2 mb-2 mr-2"> */}
                {/* <img  src="https://cdn.dribbble.com/users/3198880/screenshots/13803872/media/07cf2431ac7e4040a68ff223bca856ac.jpg" className="" style={{width:'100%',height:'100%' , borderRadius:'50px'}}></img> */}
                <div class="jumbotron jumbotron-fluid  mt-2 ml-2 mb-2 mr-2" style={{borderRadius:'50px'}}>
  <div class="container">
